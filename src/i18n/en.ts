...
const en = {
  ...
  'pluginMarket.noPluginsDesc': 'Add a marketplace to browse plugins',
  'pluginMarket.noResults': 'No matching plugins',
  ...
  'pluginMarket.installSuccess': 'Plugin Installed',
  'pluginMarket.installFailed': 'Installation Failed',
  'pluginMarket.uninstalling': 'Uninstalling...',
  'pluginMarket.version': 'v{version}',
  'pluginMarket.by': 'by {author}',
  'pluginMarket.components': 'Components',
  'pluginMarket.skills': 'Skills',
  'pluginMarket.agents': 'Agents',
  'pluginMarket.hooks': 'Hooks',
  'pluginMarket.mcpServers': 'MCP',
  'pluginMarket.lspServers': 'LSP',
  'pluginMarket.commands': 'Commands',
  'pluginMarket.scope': 'Install Scope',
  'pluginMarket.scopeUser': 'User (global)',
  'pluginMarket.scopeProject': 'Project',
  'pluginMarket.scopeLocal': 'Local',
  'pluginMarket.browseHint': 'Browse Plugin Marketplace',
  'pluginMarket.browseHintDesc': 'Discover and install Claude Code plugins',
  'pluginMarket.noReadme': 'No description available',
  ...
  'pluginMarket.category.output-styles': 'Output Styles',
  'pluginMarket.category.other': 'Other',
