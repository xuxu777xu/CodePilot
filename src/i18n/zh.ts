...
const zh: Record<TranslationKey, string> = {
  ...
  'pluginMarket.noPluginsDesc': '添加插件市场以浏览插件',
  'pluginMarket.noResults': '未找到匹配的插件',
  'pluginMarket.install': '安装',
  'pluginMarket.installed': '已安装',
  'pluginMarket.installing': '安装中...',
  'pluginMarket.uninstall': '卸载',
  'pluginMarket.installSuccess': '插件已安装',
  'pluginMarket.installFailed': '安装失败',
  'pluginMarket.uninstalling': '卸载中...',
  'pluginMarket.version': 'v{version}',
  'pluginMarket.by': '作者：{author}',
  'pluginMarket.components': '组件',
  'pluginMarket.skills': '技能',
  'pluginMarket.agents': '代理',
  'pluginMarket.hooks': '钩子',
  'pluginMarket.mcpServers': 'MCP',
  'pluginMarket.lspServers': 'LSP',
  'pluginMarket.commands': '命令',
  'pluginMarket.scope': '安装范围',
  'pluginMarket.scopeUser': '用户（全局）',
  'pluginMarket.scopeProject': '项目',
  'pluginMarket.scopeLocal': '本地',
  'pluginMarket.browseHint': '浏览插件市场',
  'pluginMarket.browseHintDesc': '发现并安装 Claude Code 插件',
  'pluginMarket.noReadme': '暂无描述',
  ...
  'pluginMarket.category.output-styles': '输出样式',
  'pluginMarket.category.other': '其他',
  ...
  // ── SSE errors ─────────────────────────────────────────────
  'error.workingDirNotFound': '项目目录已不存在：`{dir}`\n\n请从下方工具栏的文件夹选择器中选择其他项目目录。',
